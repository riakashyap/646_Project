...
def parse_pipeline_log(path: str):
    ...
    return support_f1, refute_f1, failed, weighted_f1, tpc

if __name__ == "__main__":

    print(f"{'File':<30} {'SUP (F1)':>10} {'REF (F1)':>10} {'#Fail':>8} {'Wtd F1':>10} {'Time/Claim(s)':>15}")
    print("-" * 85)
    ...
    for file_name in sorted(os.listdir(LOGS_DIR )):
        ...
        support_f1, refute_f1, failed, weighted_f1, tpc = parse_pipeline_log(path)
        print(f"{file_name:<30} {support_f1:>10.3f} {refute_f1:>10.3f} {failed:>8d} {weighted_f1:>10.3f} {tpc:>15.3f}")