...
get_ipython().system('pip uninstall -y mim mmcv')
get_ipython().system('pip install -U pip setuptools wheel')
get_ipython().system('pip install "torch>=2.1" "mmcv==2.1.0" "mmdet==3.3.0" --no-cache-dir')
...
get_ipython().system('pip install sentence-transformers faiss-cpu')
